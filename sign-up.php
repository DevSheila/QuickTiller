...
<body class="">
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="./user-dashbaord.php">
              QUICK TILLER
            </a>
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form  method="post" action="./sign-up-logic.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                   ...
                   <div class="col-lg-6 col-xl-6 col-md-6 ">
                        ...
                        <div class="mb-3">
                        <input type="file" class="form-control" placeholder=" Profile Image" name="image" id="image"required >
                        </div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-6">
                        ...
                        <div class="mb-3">
                        <input type="password" class="form-control" placeholder="confirm" name="confirm_password" required >
                        </div>
                    </div>
                   ...
                   <div class="row">
                       <div class="col-6">
                            ...
                            <button type="submit" name="sign-up" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign Up</button>
                            </div>
                       </div>
                       <div class="col-3"></div>
                       <div class="col-3"></div>
  ...
  <!-- Control Center for Quick Tiller: parallax effects, scripts for the example pages etc -->
