...
if(!(isset($_SESSION["loggedin"])) && !($_SESSION["loggedin"] === true)){
 ...
 exit;
  ...
  $quantity = 0;
  $current_category=' ';
  $isbn_value=$_SESSION['isbn_value'];
?>
<!DOCTYPE html>
<html lang="en">
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/listProduct.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-xl-8 col-lg-8 col-12">
                                  ...
                                  <form role="form text-left" method="post" action="../action/isbn.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="isbn_id" value="<?php echo $_SESSION['isbn_id']?>" class="form-control" >
                                            <input type="hidden" name="isbn_date" value="<?php echo $_SESSION['isbn_date']?>" class="form-control" >
                                            <input type="hidden" name="isbn_status" value="<?php echo $_SESSION['isbn_status']?>" class="form-control" >
                                            <input type="hidden" name="isbn_product_id" value="<?php echo $_SESSION['isbn_product_id']?>" class="form-control" >
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="#" class="font-weight-bold" target="_blank">Quick Tiller</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#" class="nav-link text-muted" target="_blank">Quick Tiller</a>
                </li>
                <li class="nav-item">
