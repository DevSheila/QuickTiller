  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Marcus Karani</a>
        </div>
      </div>
...
$strSQL= "SELECT * from student_reg ";
   ...
   $data[]=array($index=$i+1,$fname=$row['fname'],$reg=$row['reg_no'],$mail=$row['email'],$school_code=$row['school_code'],$course_code=$row['course_code']);
