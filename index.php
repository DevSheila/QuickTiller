...
<div class="login-page bg-light">
    ...
    <input type="text" class="form-control" placeholder="Enter Password" name="pass" required>
                                        ...
                                        <div class="col-sm-6">
                                            <a href="Signup.php" class="float-end text-primary"> Register</a>
                                        </div>
                        ...
                        <div class="col-md-5 ps-0 d-none d-md-block">
                            <div class="form-right h-100 bg-success text-purple text-center pt-5">
                                <i class="bi bi-bootstrap"></i>
                                <h2 class="fs-1">Welcome <br> TO <br> <img src="assets/img/stores/AQT.png" alt="" width='80'></h2>
                            </div>
                        </div>
                    </div>
                </div>
