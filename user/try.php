            ...
            <div class="col-md-6">
               <form id="request" class="main_form">
                  <div class="row">
                     ...
                     <div class=" col-md-6">
                           <label class="text-white">Room No</label>
                  ...
                  <div class="col-sm-12">
                                    <h4 style="font-weight: bold " class="text-white">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold" class="text-white">Price: <span id="price"><?php echo $get_room_price; ?></span> /-</h4>
                                    <h4 style="font-weight: bold" class="text-white">Total Amount : <span id="total_price">0</span> /-</h4>
                                </div>
               </form>
            </div>
         </div>
