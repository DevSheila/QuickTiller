    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        echo '<li class="nav-item">
          ...
          echo'<li class="nav-item">
          <a class="nav-link  " href="../barcode/scan-item.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">continue shopping</span>
          </a>
        </li>';}?>
        <li class="nav-item">
          ...
          <div class="row gx-4">
            <div class="col-auto">
              <div class="avatar avatar-xl position-relative">
                <img src="../admin/uploads/shops/" alt="" class="w-100 border-radius-lg shadow-sm">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="d-flex flex-column h-100">
                  <p class="mb-1 pt-2 text-bold">PROMOTIONS</p>
                  <h5 class="font-weight-bolder">PROMO DETAILS</h5>
                  <p class="mb-5">Buy exclusively for three months using AQT and get a gift hamper for two.</p>
        ...
        <div class="card h-100 p-3">
          <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../admin/assets/img/ivancik.jpg');">
            ...
            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
              <h5 class="text-white font-weight-bolder mb-4 pt-2">Shopp with AQT</h5>
              <p class="text-white">We give you free time to overthrow all the ques,crowds and best of all we give you freedom</p>
        ...
        <div class="card z-index-2">
          <div class="card-body p-3">
            <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
              ...
              <img class="border-radius-lg img-fluid m-2" src="../admin/uploads/shops/<?php echo $shop_image;?>" alt="">

            </div>

            <h6 class="ms-2 mt-4 mb-0"> <?php echo $shop_name;?> </h6>
              <p class="text-sm ms-2"> <span class="font-weight-bolder"><i class="fas fa-map-marker-alt"></i></span><?php echo  $shop_location;?></p>
